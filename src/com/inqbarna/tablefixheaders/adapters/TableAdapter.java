...
public interface TableAdapter {
	 ...
	 * {@link #getView(int, int, android.view.View, android.view.ViewGroup)}.
	 *
	 ...
	 * {@link #getView(int, int, android.view.View, android.view.ViewGroup)} for the specified item.
	 *
	 * @param row
	 *            The row of the item within the adapter's data table of the
	 *            item whose view we want. If the row is <code>-1</code> it is
	 ...
	 *         {@link #getView(int, int, android.view.View, android.view.ViewGroup)}). Note: Integers must
	 ...
	 * {@link #getView(int, int, android.view.View, android.view.ViewGroup)}. Each type represents a set
	 * of views that can be converted in
	 * {@link #getView(int, int, android.view.View, android.view.ViewGroup)}. If the adapter always
